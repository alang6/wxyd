...
入口复制到jd：
21.0复制整段话 Https:/JoiHBgZNhT9Qh1 入会瓜分百万京豆 至高赢千元好礼#AAa2B3iyJa%咑開京岽app

更新地址：https://github.com/Tsukasa007/my_script
============Quantumultx===============
[task_local]
#8.28-9.22 开学新花young 热爱不限量
5 0,5,18 * * * jd_opencard_school_opens.js, tag=8.28-9.22 开学新花young 热爱不限量, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_opencard_school_opens.png, enabled=true
*/
const $ = new Env('8.28-9.22 开学新花young 热爱不限量');
...
function followShop() {
    return new Promise(resolve => {
        let body = `activityId=46fcab8e90e243dcb1aa76a5c7c764d2&pin=${encodeURIComponent($.myPingData.secretPin)}&actorUuid=${$.actorUuid}&taskType=23&taskValue=1000009621&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}`
...
function getDrawRecordHasCoupon() {
    return new Promise(resolve => {
        let body = `activityId=46fcab8e90e243dcb1aa76a5c7c764d2&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function saveTask() {
    return new Promise(resolve => {
        let body = `activityId=46fcab8e90e243dcb1aa76a5c7c764d2&pin=${encodeURIComponent($.myPingData.secretPin)}&taskType=2&taskValue=2736969&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}`
...
async function startDraw(type) {
    return new Promise(resolve => {
        let body = `activityId=46fcab8e90e243dcb1aa76a5c7c764d2&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}&pin=${encodeURIComponent($.myPingData.secretPin)}&type=${type}`
        $.post(taskPostUrl('/dingzhi/dz/openCard/startDraw', body, `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/805745?activityId=46fcab8e90e243dcb1aa76a5c7c764d2&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}`), async (err, resp, data) => {
            try {
                if (err) {
                    console.log(`${$.name} API请求失败，请检查网路重试`)
                } else {
...
function getHtml() {
    return new Promise(resolve => {
        $.get({
            url: `https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/797702?activityId=46fcab8e90e243dcb1aa76a5c7c764d2&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}&adsource=null&shareuserid4minipg=P0CZ6sYjxiDL7YQZAjODCU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==&shopid=1000009621&lng=113.387958&lat=22.511013&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0`,
            headers: {
...
function adLog() {
    return new Promise(resolve => {
        $.post({
            ...
            body: `venderId=1000009621&code=99&pin=${encodeURIComponent($.myPingData.secretPin)}&activityId=46fcab8e90e243dcb1aa76a5c7c764d2&pageUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/797702?activityId=46fcab8e90e243dcb1aa76a5c7c764d2&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}&adsource=null&shareuserid4minipg=P0CZ6sYjxiDL7YQZAjODCU7oeVP9kq2pYSH90mYt4m3fwcJlClpxrfmVYaGKuquQkdK3rLBQpEQH9V4tdrrh0w==&shopid=1000009621&lng=113.387958&lat=22.511013&sid=09fdc8e908526b5538a4ad4a265f40dw&un_area=19_1657_52093_0`,
            headers: {
                'User-Agent': `Mozilla/5.0 (Linux; U; Android 8.0.0; zh-cn; Mi Note 2 Build/OPR1.170623.032) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/61.0.3163.128 Mobile Safari/537.36 XiaoMi/MiuiBrowser/10.1.1`,
                'Host': 'lzdz1-isv.isvjcloud.com',
...
function checkOpenCard() {
    return new Promise(resolve => {
        let body = `activityId=46fcab8e90e243dcb1aa76a5c7c764d2&actorUuid=${$.actorUuid}&shareUuid=${$.shareUuid}&pin=${encodeURIComponent($.myPingData.secretPin)}`
...
function taskPostUrl(url, body, referer) {
    return {
        ...
        headers: {
            ...
            "Referer": referer ? referer : `https://lzdz1-isv.isvjcloud.com/lzclient/dz/2021jan/eliminateGame/0713eliminate/?activityId=735c30216dc640638ceb6e63ff6d8b17&shareUuid=${$.shareUuid ? $.shareUuid : 'e6f94cea7ba447bab41d16fb1dacab8f'}&adsource=&shareuserid4minipg=u%2FcWHIy7%2Fx3Ij%20HjfbnnePkaL5GGqMTUc8u%2Fotw2E%20a7Ak3lgFoFQlZmf45w8Jzw&shopid=0&lng=114.062541&lat=29.541254&sid=57b59835c68ed8959d124d644f61c58w&un_area=4_48201_54794_0`,
            "User-Agent": UA,
