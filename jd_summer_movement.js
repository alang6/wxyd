...
const maxBet =  $.isNode() ? (process.env.MAX_BET ? process.env.MAX_BET : true):true;
//环境变量NOT_BET，设置不下注的奖品。默认值['舒尔佳胶囊']
const notBet =  $.isNode() ? (process.env.NOT_BET ? process.env.NOT_BET : ['舒尔佳胶囊','杜蕾斯超薄款']):['舒尔佳胶囊','杜蕾斯超薄款'];
