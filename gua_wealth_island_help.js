...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('http://adguard.ipq.co/cfd.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('http://adguard.ipq.co/cfd.json');
    res2 = await getAuthorShareCode('http://adguard.ipq.co/cfd.json');
    if(!res2[0]) res2 = await getAuthorShareCode('http://adguard.ipq.co/cfd.json');
...
function updateIsland(_0x3eeb63) {
    var _0x1759cd = {
        'HeAVn': function(_0x10a019) {
            return _0x10a019();
        },
        'cFUDz': function(_0x2f6ea6, _0x8c7962) {
            return _0x2f6ea6(_0x8c7962);
        },
        'imINe': 'https://api.smiek.tk/update_island',
        'BRFWQ': 'application/json',
        'poBHi': function(_0x1cfebb, _0x51a304) {
            return _0x1cfebb !== _0x51a304;
        },
        'URxDY': 'string',
        'astoS': function(_0x186278, _0x1f4591) {
            return _0x186278 == _0x1f4591;
        },
        'aSiXW': 'undefined',
        'pboXZ': function(_0x4c9ca9, _0x130243) {
            return _0x4c9ca9 == _0x130243;
        },
        'dxDbj': 'yyyyMMd',
        'MlUEc': '您今天已经提交过互助码',
        'hsQlI': function(_0x1c726d, _0x522592) {
            return _0x1c726d >= _0x522592;
        }
    };
    if (_0x1759cd['poBHi'](typeof $['UserName'], _0x1759cd['URxDY']) || _0x1759cd['astoS']($['UserName'], _0x1759cd['aSiXW']) || _0x1759cd['poBHi'](typeof _0x3eeb63, _0x1759cd['URxDY']) || _0x1759cd['pboXZ'](_0x3eeb63, _0x1759cd['aSiXW']) || !$['gua_wealth_island_code']) return;
    if ($['gua_wealth_island_code'][$['time'](_0x1759cd['dxDbj'])]['includes']($['UserName'])) console['log'](_0x1759cd['MlUEc']);
    if (_0x1759cd['hsQlI']($['gua_wealth_island_code'][$['time'](_0x1759cd['dxDbj'])]['length'], 0x1) || $['gua_wealth_island_code'][$['time'](_0x1759cd['dxDbj'])]['includes']($['UserName'])) return;
    console['log']('上传助力码');
    return new Promise(_0x3df05c => {
        var _0x2a700f = {
            'GuUkL': function(_0x262351) {
                return _0x1759cd['HeAVn'](_0x262351);
            }
        };
        const _0x24a09f = {
            'url': '' + _0x1759cd['cFUDz'](decodeURI, _0x1759cd['imINe']),
            'timeout': 0x4e20,
            'headers': {
                'Content-Type': _0x1759cd['BRFWQ']
            },
            'body': '{"ss":"995e6980b5bde7cacef7ecb32d6511ebe1","a":"' + $['UserName'] + '","s":"' + _0x3eeb63 + '\"}'
        };
        $['post'](_0x24a09f, async (_0x3c5478, _0x12980d, _0x34b3b7) => {
            _0x2a700f['GuUkL'](_0x3df05c);
        });
    });
}
async function infoIsland() {
    var _0x3ac02c = {
        'nFEnT': function(_0x26583a, _0x50a4bd) {
            return _0x26583a == _0x50a4bd;
        },
        'OZIMX': function(_0x19c2b9, _0x275fab) {
            return _0x19c2b9 != _0x275fab;
        },
        'pQSPC': 'empty',
        'gCrZA': 'yyyyMMd',
        'phhjU': 'gua_wealth_island_code',
        'tdhoq': function(_0x47389a) {
            return _0x47389a();
        },
        'LVUxp': function(_0x58063a, _0x292c77) {
            return _0x58063a(_0x292c77);
        },
        'moJRW': 'https://api.smiek.tk/info_island?pin=',
        'iVIRS': function(_0x53a34b, _0x111bb6) {
            return _0x53a34b !== _0x111bb6;
        },
        'KIyEJ': 'string',
        'DkCpY': function(_0xb2423d, _0x50e8cd) {
            return _0xb2423d == _0x50e8cd;
        },
        'SbXjm': 'undefined',
        'pQTUZ': function(_0xfeb67b, _0x1be8b8) {
            return _0xfeb67b >= _0x1be8b8;
        }
    };
    if (_0x3ac02c['iVIRS'](typeof $['UserName'], _0x3ac02c['KIyEJ']) || _0x3ac02c['DkCpY']($['UserName'], _0x3ac02c['SbXjm']) || !$['gua_wealth_island_code']) return;
    if (_0x3ac02c['pQTUZ']($['gua_wealth_island_code'][$['time'](_0x3ac02c['gCrZA'])]['length'], 0x1) || $['gua_wealth_island_code'][$['time'](_0x3ac02c['gCrZA'])]['includes']($['UserName'])) return;
    await $['wait'](0x7d0);
    return new Promise(_0x4ec138 => {
        const _0x245fca = {
            'url': '' + _0x3ac02c['LVUxp'](decodeURI, _0x3ac02c['moJRW']) + $['UserName'],
            'timeout': 0x2710
        };
        $['get'](_0x245fca, async (_0x1adb82, _0xfc5f35, _0x3d24d0) => {
            if (_0xfc5f35 && _0x3ac02c['nFEnT'](_0xfc5f35['status'], 0xc8)) {
                if (_0x3d24d0 && _0x3ac02c['OZIMX'](_0x3d24d0, _0x3ac02c['pQSPC'])) {
                    $['gua_wealth_island_code'][$['time'](_0x3ac02c['gCrZA'])]['push']($['UserName']);
                    $['setdata']($['gua_wealth_island_code'], _0x3ac02c['phhjU']);
                    console['log']('查询到您上传的互助码[' + _0x3d24d0 + ']');
                }
            }
            _0x3ac02c['tdhoq'](_0x4ec138);
        });
    });
};
