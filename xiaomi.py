#跳转到底部user = "123"和passwd = "123"，修改成自己小米运动账号和密码
#docker crontab.list加入任务清单（xiaomi-step.py文件放在/jd/scripts/文件夹内，建议17时之后运行） 30 17 * * * python3 /jd/scripts/xiaomi-step.py 
# -*- coding: UTF-8 -*-
# python >=3.8
...
TG_BOT_TOKEN = "1611000815:AAF_rcIYerjPN7AJQGbNie6wJtP8OZBghgA"           # telegram bot token 自行申请
TG_USER_ID = "968486336"             # telegram 用户ID
