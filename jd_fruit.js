...
!(async() => {
    ...
    for (let i = 0; i < accountNum; i++) {
        if (cookies[i]) {
            $.cknum = i + 1;
            console.log('\r\n★★★★★开始执行第 ${$.cknum} 个账号,共' + cookies.length + '个账号★★★★★');
