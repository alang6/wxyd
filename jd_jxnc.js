...
function getJxToken() {
    var _0xa422 = {
        'lGSBc': 'abcdefghijklmnopqrstuvwxyz1234567890',
        'zYXMd': function(_0x3fddf8, _0x2e8c46) {
            return _0x3fddf8(_0x2e8c46);
        },
        'EtUUR': function(_0xc1dc78, _0x2dd44b) {
            return _0xc1dc78(_0x2dd44b);
        },
        'fhrXi': function(_0x4b8614) {
            return _0x4b8614();
        }
    };

    function _0x2cfb27(_0x3d541e) {
        let _0x19600a = _0xa422['lGSBc'];
        let _0x1a62e9 = '';
        for (let _0x44ee85 = 0x0; _0x44ee85 < _0x3d541e; _0x44ee85++) {
            _0x1a62e9 += _0x19600a[parseInt(Math['random']() * _0x19600a['length'])];
        }
        return _0x1a62e9;
    }
    return new Promise(_0x3d4dca => {
        let _0x1934d2 = _0xa422['zYXMd'](_0x2cfb27, 0x28);
        let _0x140a50 = (+new Date())['toString']();
        if (!currentCookie['match'](/pt_pin=([^; ]+)(?=;?)/)) {
            console['log']('此账号cookie填写不规范,你的pt_pin=xxx后面没分号(;)\n');
            _0x3d4dca(null);
        }
        let _0x1ab949 = currentCookie['match'](/pt_pin=([^; ]+)(?=;?)/)[0x1];
        let _0xa37fe3 = $['md5']('' + _0xa422['EtUUR'](decodeURIComponent, _0x1ab949) + _0x140a50 + _0x1934d2 + 'tPOamqCuk9NLgVPAljUyIHcPRmKlVxDy')['toString']();
        currentToken = {
            'timestamp': _0x140a50,
            'phoneid': _0x1934d2,
            'farm_jstoken': _0xa37fe3
        };
        _0xa422['fhrXi'](_0x3d4dca);
    });
};
