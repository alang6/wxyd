/*
一键获取互助码(邀请码)修复版
修复新版财富岛互助码获取，新增健康社区、口袋商店获取
结合本仓库jd_get_share_code_format.js脚本，docker一键更新容器下所有账号互助码
author:msechen
time:2021-9-7
 */
const $ = new Env("获取互助码");
...
_0xod8 = 'jsjiami.com.v6'
  ...
  function taskUrl(function_path, body = '', dwEnv = 7) {
    let url = `${JX_API_HOST}jxbfd/${function_path}?strZone=jxbfd&bizCode=jxbfd&source=jxbfd&dwEnv=${dwEnv}&_cfd_t=${Date.now()}&ptag=138631.26.55&${body}&_stk=_cfd_t%2CbizCode%2CddwTaskId%2CdwEnv%2Cptag%2Csource%2CstrShareId%2CstrZone&_ste=1`;
