...
const dyjCode = $.isNode()
	? process.env.dyjCode
		? process.env.dyjCode
		: '3beaede7cc0d4677aaec5338cc4898cb10641632585663736@QjbG7npj44R73JIjks18BQ'
	: '3beaede7cc0d4677aaec5338cc4898cb10641632585663736@QjbG7npj44R73JIjks18BQ' //邀请码变量，不支持多账号，格式：redEnvelopeId@markedPin
const myCode = [
	{
		rid: '3beaede7cc0d4677aaec5338cc4898cb10641632585663736',
		inviter: 'QjbG7npj44R73JIjks18BQ'
	},
	{
		rid: '',
		inviter: ''
...
if ($.isNode()) {
	...
	cookiesArr = [$.getdata('CookieJD'), $.getdata('CookieJD2'), ...jsonParse($.getdata('CookiesJD') || '[]').map(item => item.cookie)].filter(
		item => !!item
	)
}
...
function getAuthorShareCode() {
	return new Promise(resolve => {
		$.get(
			{
				url: 'https://xxxxxxxxxxxxx/dyj.json',
				headers: {
					'User-Agent':
