...
[task_local]
#jd_cookieCheck
0 0 1/6 * * ? jd_cookieCheck.js, tag=cookieCheck, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/cookieCheck.png, enabled=true
 */
const $ = new Env('CK检测');
...
async function GetJDUserInfoUnion() {
