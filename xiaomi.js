...
// 小米运动账号
const accounts = [
    { phone: '18672333058', password: 'ah2012179', steps: random(20000, 21000) },
    { phone: '15827041151', password: 'csq19960523', steps: random(22000, 23000) },
    { phone: '18717194885', password: 'hnkdzy130', steps: random(22000, 23000) },
    { phone: '15207374195', password: 'ztzt2000', steps: random(23000, 50000) },
    { phone: '18972963996', password: '131452cc', steps: random(30000, 99000) },
    { phone: '18062791339', password: 'a66666666', steps: random(22000, 23000) },
    { phone: '15072303141', password: '20206364hubo027', steps: random(22000, 23000) },
    { phone: '136667147579', password: 'tlw198001170', steps: random(3000, 43000) },
]
...
async function start() {
    accounts.forEach(async (item, index) => {
        ...
        if (result.code == 1) {
            ...
            await notify.sendNotify(`小米刷步数通知`,`账号 ${item.phone} 步数刷新成功，当前 ${item.steps} 步.`)
        } else {
